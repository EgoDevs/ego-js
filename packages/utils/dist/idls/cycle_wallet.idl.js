export var idlFactory = function(param) {
    ...
    var Event128 = IDL.Record({
        "id": IDL.Nat32,
        "kind": EventKind128,
        "timestamp": IDL.Nat64
    });
    var ManagedCanisterEventKind = IDL.Variant({
        "CyclesSent": IDL.Record({
            "amount": IDL.Nat64,
            "refund": IDL.Nat64
        }),
    ...
    var ManagedCanisterEvent = IDL.Record({
        "id": IDL.Nat32,
        "kind": ManagedCanisterEventKind,
        "timestamp": IDL.Nat64
    });
    var ManagedCanisterEventKind128 = IDL.Variant({
        "CyclesSent": IDL.Record({
            "amount": IDL.Nat,
            "refund": IDL.Nat
        }),
    ...
    var ManagedCanisterEvent128 = IDL.Record({
        "id": IDL.Nat32,
    ...
    var ManagedCanisterInfo = IDL.Record({
        "id": IDL.Principal,
        "name": IDL.Opt(IDL.Text),
    ...
    var CreateCanisterArgs128 = IDL.Record({
        "cycles": IDL.Nat,
        "settings": CanisterSettings
    });
    var ReceiveOptions = IDL.Record({
        "memo": IDL.Opt(IDL.Text)
    });
    return IDL.Service({
        ...
        "list_addresses": IDL.Func([], [
            IDL.Vec(AddressEntry)
        ], [
            "query"
        ]),
