...
var idlFactory = function(param) {
    ...
    var AppMainInstallRequest = IDL.Record({
        wasm: Wasm,
    ...
    var AppMainUpgradeRequest = IDL.Record({
        canister_id: IDL.Principal,
        wasm: Wasm
    });
    ...
    return IDL.Service({
        app_main_delete: IDL.Func([
            IDL.Principal
        ], [
            Result
        ], []),
        app_main_install: IDL.Func([
            AppMainInstallRequest
        ], [
            Result_1
        ], []),
        app_main_upgrade: IDL.Func([
            AppMainUpgradeRequest
        ], [
            Result_2
        ], []),
        ...
        wallet_cycle_recharge: IDL.Func([
            IDL.Nat
        ], [
            Result
        ], [])
