...
export type AppVersionStatus = { NEW: null } | { REJECTED: null } | { SUBMITTED: null } | { REVOKED: null } | { RELEASED: null } | { APPROVED: null };
...
export type Result_11 = { Ok: Array<Developer> } | { Err: EgoError };
...
export interface _SERVICE {
  ...
  app_version_set_frontend_address: ActorMethod<[AppVersionSetFrontendAddressRequest], Result_1>;
