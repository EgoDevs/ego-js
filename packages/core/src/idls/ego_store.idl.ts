export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    admin_wallet_cycle_recharge: IDL.Func([AdminWalletCycleRechargeRequest], [Result], []),
    admin_wallet_order_list: IDL.Func([], [Result_1], []),
    admin_wallet_provider_add: IDL.Func([AdminWalletProviderAddRequest], [Result_2], []),
    ...
    ego_owner_add_with_name: IDL.Func([IDL.Text, IDL.Principal], [Result_6], []),
    ...
    wallet_cycle_charge: IDL.Func([WalletCycleChargeRequest], [Result_14], []),
