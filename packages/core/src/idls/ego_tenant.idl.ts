export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    canister_main_track: IDL.Func([IDL.Principal, IDL.Principal], [Result], []),
    ...
    ego_cycle_check_cb: IDL.Func([IDL.Vec(CycleRecord), IDL.Nat], [Result], []),
    ...
    ego_owner_add_with_name: IDL.Func([IDL.Text, IDL.Principal], [Result_3], []),
